...
// ─────────────────────────────────────────────────────────────────────────────
// COD success page (Cash on Delivery)
// ─────────────────────────────────────────────────────────────────────────────
                ...
                {[
                  {
                    ...
                    sub: "We have your order and are preparing it",
                    done: true,
                  },
                  {
                    icon: Package,
                  ...
                  },
                  {
                    ...
                    color: "bg-amber-500",
                    label: "Out for delivery",
                    sub: "Rider is on the way — have your cash ready",
                    done: false,
                  },
                  {
                    icon: Banknote,
                    ...
                    sub: "Hand cash to the rider and enjoy!",
                    done: false,
                  },
                ].map((step, i, arr) => (
                  <div key={i} className="flex gap-4">
...
// ─────────────────────────────────────────────────────────────────────────────
// Root export — reads ?method=cod from URL and branches
// ─────────────────────────────────────────────────────────────────────────────
export default function OrderSuccessPage() {
  ...
  useEffect(() => {
    // Resolve orderId from localStorage if missing (Paystack redirect case — no orderId in URL)
    if (!urlOrderId) {
      const stored = localStorage.getItem("pending_order_id");
      if (stored) setOrderId(stored);
    }

    // Clear cart — safe universal clear point for both flows
    dispatch(clearCart());
